...
func makeGetBookListEndpoint() endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		bl.BookList = append(bl.BookList, &book.BookInfo{BookId: 1, BookName: "21天精通php server 3-"})
		bl.BookList = append(bl.BookList, &book.BookInfo{BookId: 2, BookName: "21天精通java server 3- "})
		return bl, nil
	}
}
...
func main() {
	...
	fmt.Println("server 4----serviceAddress " + serviceAddress)
	gs.Serve(ls)
}

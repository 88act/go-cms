  ...
  <!----------查询form------------------ -->
      ...
      <el-form-item label="创建时间">
        ...
        <el-form-item label="ID">
            <el-input placeholder="搜索ID" v-model="searchInfo.ID" />
                ...
                <el-form-item label="0 保密 1 男 2 女" prop="sex">                
   ...
   <!----------数据表------------------ -->
    ...
    >
      ...
      <!--pws BeHide --> 
      <!--pwsSlat BeHide --> 
          <el-table-column label="邮件" prop="email" width="120"    /> 
          <el-table-column label="手机" prop="mobile" width="120"    /> 
          <el-table-column label="昵称" prop="nickname" width="120"    /> 
          <el-table-column label="真实名" prop="realname" width="120"    /> 
      <!--cardId BeHide -->
          <!--sex  BeQuickEdit -->
        <el-table-column label="0 保密 1 男 2 女" prop="sex" width="120"  sortable="custom" >
      ...
      <!--birthday BeHide --> 
      <!--avatar BeHide --> 
      <!--mobileValidated BeHide --> 
      <!--emailValidated BeHide --> 
      <!--realnameValidated BeHide --> 
      <!--loginTimes BeHide --> 
      <!--recommendId BeHide --> 
      <!--recommendId2 BeHide --> 
          <el-table-column label="推荐码16位（自己的）" prop="recommendCode" width="120"    />
          <!--status  BeQuickEdit -->
        ...
        <el-popover trigger="click" placement="top"  width = "280">  
          ...
          <el-table-column label="安全状态" prop="statusSafe" width="120"    /> 
      <!--regIp BeHide --> 
      <!--lastLoginIp BeHide -->
            <el-table-column label="最后登录时间" width="180" prop="lastLoginTime"   >
    ...
    <el-dialog  v-if="dialogFormVisible"  :before-close="closeDialog" v-model="dialogFormVisible" title="编辑资料">
      <el-form :model="formData" label-position="right" label-width="80px">
        ...
        <el-form-item label="0 保密 1 男 2 女:">
        ...
        <el-form-item label="安全状态:">
                 <el-input v-model.number="formData.statusSafe" clearable placeholder="请输入" />
       </el-form-item>

            ...
            <div class="user-information">
              <ul>
                ...
                <el-tooltip class="item" effect="light"  placement="top">
                  <li>
                    <i class="el-icon-data-analysis" /> GO-CMS 
                  </li>
                </el-tooltip>
                <li>
                  <i class="el-icon-video-camera-solid" />中国·广东
                </li>
                <el-tooltip class="item" effect="light" content="GO-CMS " placement="top">
                  <li>
                    <i class="el-icon-medal-1" />GO-CMS 
                  </li>
                </el-tooltip>

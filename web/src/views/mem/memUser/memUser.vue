					...
					<el-form-item label="创建时间">
						<el-date-picker v-model="searchInfo.createdAtBetween" type="datetimerange"
							...
							<el-form-item label="id">
								...
								<el-input placeholder="搜索条件" v-model="searchInfo.password" clearable />
								</el-form-item>
								<el-form-item label="密码盐">
								<el-input placeholder="搜索条件" v-model="searchInfo.passwordSlat" clearable />
								</el-form-item>
								...
								<el-form-item label="角色list">
								<el-input placeholder="搜索条件" v-model="searchInfo.roleList" clearable />
								</el-form-item>
								<el-form-item label="角色">
									<el-input placeholder="搜索条件" v-model="searchInfo.role" clearable />
								</el-form-item>
								<el-form-item label="类型" prop="userType">
									<el-select v-model="searchInfo.userType" placeholder="请选择" clearable>
									<el-option v-for="(item,key) in user_rela_options" :key="key" :label="item.label" :value="item.value"></el-option>
									</el-select>
								</el-form-item>
							...
							/>
								...
								<el-form-item label="岗位">
									<el-input placeholder="搜索条件" v-model="searchInfo.jobId" clearable />
								</el-form-item>
								<el-form-item label="部门">
									<el-input placeholder="搜索条件" v-model="searchInfo.departId" clearable />
								</el-form-item>
							...
							<el-select v-model="searchInfo.cardidValidated" clearable placeholder="请选择">
								...
								<el-input placeholder="搜索条件" v-model="searchInfo.remark" clearable />
								</el-form-item>
								...
								<el-form-item label="登录次数">
									<el-input placeholder="搜索条件" v-model="searchInfo.loginTotal" clearable />
								</el-form-item>
							...
							/>
								...
								<el-input placeholder="搜索条件" v-model="searchInfo.scan" clearable />
								</el-form-item>
							<el-form-item label="扫码">
								<el-date-picker
								v-model="searchInfo.scanTime"
								type="datetimerange"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss" :shortcuts="shortcuts" range-separator="至"
								start-placeholder="开始日期"
							...
							/>
								...
								<el-input placeholder="搜索条件" v-model="searchInfo.setting" clearable />
								</el-form-item>
								<el-form-item label="远程协助模式">
									<el-input placeholder="搜索条件" v-model="searchInfo.rtcModel" clearable />
								</el-form-item>

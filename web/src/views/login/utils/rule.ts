...
/**弱：纯数字，纯字母，纯特殊字符 // 密码6-24位,字母/数字/符号(除空格)*/
export const REGEXP_PWD = /^(?:\d+|[a-zA-Z]+|[!@#$%^&*]+){6,24}$/;
/** 密码正则（密码格式应为6-18位数字、字母、符号的任意两种组合） */
//  /^(?![0-9]+$)(?![a-z]+$)(?![A-Z]+$)(?!([^(0-9a-zA-Z)]|[()])+$)(?!^.*[\u4E00-\u9FA5].*$)([^(0-9a-zA-Z)]|[()]|[a-z]|[A-Z]|[0-9]){8,18}$/;

//弱：纯数字，纯字母，纯特殊字符 // 密码6-24位,字母/数字/符号(除空格)
export const REGEXP_PWD_1 = /^(?:\d+|[a-zA-Z]+|[!@#$%^&*]+){6,24}$/;
//强: 密码6-24位,字母/数字/符号(除空格),且至少包含两种
export const REGEXP_PWD_2 =
  /^(?![\d]+$)(?![a-zA-Z]+$)(?![^\da-zA-Z]+$)([^\u4e00-\u9fa5\s]){6,24}$/;

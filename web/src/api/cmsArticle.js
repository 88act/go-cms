...
// @Tags CmsArticle
// @Summary 导出excelCmsArticle列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页导出excelCmsArticle列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /cmsArticle/getCmsArticleexcelList [get]
export const excelList = (params) => {
  return service({
    url: '/cmsArticle/excelList',
    method: 'get',
    params
  })
}
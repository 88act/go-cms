...
// @accept application/json
// @Produce application/json
// @Param data query model.K8sNamespaces true "用id查询K8sNamespaces"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取K8sNamespaces列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
// @accept application/json
// @Produce application/json
// @Param data body model.K8sNamespaces true "快速编辑"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /k8sNamespaces/quickEdit [post]
export const quickEdit = (data) => {
  return service({
    url: '/k8sNamespaces/quickEdit',
    method: 'post',
    data
  })
}
...
// @Tags K8sNamespaces
// @Summary 导出excelK8sNamespaces列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页导出excelK8sNamespaces列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /k8sNamespaces/getK8sNamespacesexcelList [get]
export const excelList = (params) => {
  return service({
    url: '/k8sNamespaces/excelList',
    method: 'get',
    params
  })
}
...
// @Tags CmsAdSeat
// @Summary 导出excelCmsAdSeat列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页导出excelCmsAdSeat列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /cmsAdSeat/getCmsAdSeatexcelList [get]
export const excelList = (params) => {
  return service({
    url: '/cmsAdSeat/excelList',
    method: 'get',
    params
  })
}
...
// get send data
func (l *PaySuccessNotifyUserHandler) getData(_ context.Context, order *model.OrderOrder, openId string) []*subscribe.Message {
	...
	return []*subscribe.Message{
		{
			...
			Data: map[string]*subscribe.DataItem{
				...
				"thing1":            {Value: order.Remark},
				"amount2":           {Value: fmt.Sprintf("%.2f", tool.Fen2Yuan(int64(*order.Price)))},
		...
		},
		{
			...
			Data: map[string]*subscribe.DataItem{
				...
				"character_string4": {Value: order.OrderCode},

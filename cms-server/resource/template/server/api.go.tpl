...
var {{.Abbreviation}}Service = service.ServiceGroupApp.BusinessServiceGroup.{{.StructName}}Service
...
func ({{.Abbreviation}}Api *{{.StructName}}Api) Create{{.StructName}}(c *gin.Context) {
	...
	if err := {{.Abbreviation}}Service.Create{{.StructName}}(dataObj); err != nil {
...
func ({{.Abbreviation}}Api *{{.StructName}}Api) Update{{.StructName}}(c *gin.Context) {
	...
	if err := {{.Abbreviation}}Service.Update{{.StructName}}(dataObj); err != nil {
...
// @accept application/json
// @Produce application/json
// @Param data query businessReq.{{.StructName}}Search true "分页获取{{.StructName}}列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"

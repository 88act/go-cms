...
type ImTxMsgFileMini struct {
	...
	ExpireTime *time.Time `json:"expireTime" cn:"过期时间" form:"expireTime" gorm:"column:expire_time;comment:过期时间;type:time"`
	FileSize   *int       `json:"fileSize" cn:"文件大小" form:"fileSize" gorm:"column:file_size;comment:文件大小;type:int"`
	FileMd5    *int       `json:"fileMd5" cn:"文件md5" form:"fileMd5" gorm:"column:file_md5;comment:文件md5;type:int"`
	GzipSize   *int       `json:"gzipSize" cn:"压缩大小" form:"gzipSize" gorm:"column:gzip_size;comment:压缩大小;type:int"`
	GzipMd5    *int       `json:"gzipMd5" cn:"压缩md5" form:"gzipMd5" gorm:"column:gzip_md5;comment:压缩md5;type:int"`

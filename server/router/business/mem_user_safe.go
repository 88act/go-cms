...
func (s *MemUserSafeRouter) InitMemUserSafeRouter(Router *gin.RouterGroup) {
	...
	var apiV1 = v1.ApiGroupApp.BusinessApiGroup.MemUserSafeApi
	{
		...
		router.DELETE("deleteMemUserSafe", apiV1.DeleteMemUserSafe)           // 删除MemUserSafe
		router.DELETE("deleteMemUserSafeByIds", apiV1.DeleteMemUserSafeByIds) // 批量删除MemUserSafe
		router.PUT("updateMemUserSafe", apiV1.UpdateMemUserSafe)              // 更新MemUserSafe

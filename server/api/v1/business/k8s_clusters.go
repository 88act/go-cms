...
func (k8sClustersApi *K8sClustersApi) CreateK8sClusters(c *gin.Context) {
	...
	if err := bizSev.GetK8sClustersService().CreateK8sClusters(dataObj); err != nil {
...
func (k8sClustersApi *K8sClustersApi) DeleteK8sClusters(c *gin.Context) {
	...
	if err := bizSev.GetK8sClustersService().DeleteK8sClusters(k8sClusters); err != nil {
...
func (k8sClustersApi *K8sClustersApi) DeleteK8sClustersByIds(c *gin.Context) {
	...
	if err := bizSev.GetK8sClustersService().DeleteK8sClustersByIds(IDS); err != nil {
...
func (k8sClustersApi *K8sClustersApi) UpdateK8sClusters(c *gin.Context) {
	...
	if err := bizSev.GetK8sClustersService().UpdateK8sClusters(dataObj); err != nil {
...
func (k8sClustersApi *K8sClustersApi) FindK8sClusters(c *gin.Context) {
	...
	rek8sClusters, err := bizSev.GetK8sClustersService().GetK8sClusters(k8sClusters.ID, "")
...
func (k8sClustersApi *K8sClustersApi) GetK8sClustersList(c *gin.Context) {
	...
	if list, total, err := bizSev.GetK8sClustersService().GetK8sClustersInfoList(pageInfo, createdAtBetween, ""); err != nil {
...
// GetK8sClustersList 分页导出excel K8sClusters列表
// @Tags K8sClusters

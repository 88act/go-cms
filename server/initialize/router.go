...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		businessRouter.InitActFavRouter(PrivateGroup)

		businessRouter.InitActActRouter(PrivateGroup)
		businessRouter.InitActShopRouter(PrivateGroup)
		businessRouter.InitMemUserRouter(PrivateGroup)
		businessRouter.InitOrderOrderRouter(PrivateGroup)
		businessRouter.InitPayPaymentRouter(PrivateGroup)
